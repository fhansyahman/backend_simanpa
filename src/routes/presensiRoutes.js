...
router.get('/admin/perbulan', authenticate, authorize('admin', 'atasan'), getAllPresensiPerBulan);
...
router.get('/admin/dashboard-kehadiran', authenticate, authorize('admin'), getDashboardKehadiran);
router.get('/admin/daftar-belum-absen', authenticate, authorize('admin'), getDaftarBelumAbsen);
// Manual trigger update status akhir hari
